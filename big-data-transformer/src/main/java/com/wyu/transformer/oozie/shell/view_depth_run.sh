...
sqoop export --connect jdbc:mysql://192.168.1.105:3306/report --username root --password 123456 --table stats_view_depth --export-dir /hive/stats_view_depth/00000* --input-fields-terminated-by "\\01" --update-mode allowinsert --update-key platform_dimension_id,date_dimension_id,kpi_dimension_id
