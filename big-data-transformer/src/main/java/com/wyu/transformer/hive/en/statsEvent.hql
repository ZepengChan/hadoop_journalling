...
-- 7. sqoop脚步编写
sqoop export --connect jdbc:mysql://192.168.1.106:3306/report --username root --password 123456 --table stats_event --export-dir /hive/stats_event/* --input-fields-terminated-by "\\01" --update-mode allowinsert --update-key platform_dimension_id,date_dimension_id,event_dimension_id
