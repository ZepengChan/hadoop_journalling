...
-- 3. 上传big-data-transformer-0.0.1-SNAPSHOT.jar到linux集群和hdfs集群上，然后启动DimensionConverterServer服务
-- 4. 创建function
create function currency_type_convert as 'com.wyu.transformer.hive.CurrencyTypeDimensionUDF' using jar 'hdfs://hh:8020/wyu/transformer/big-data-transformer-0.0.1-SNAPSHOT.jar';
create function payment_type_convert as 'com.wyu.transformer.hive.PaymentTypeDimensionUDF' using jar 'hdfs://hh:8020/wyu/transformer/big-data-transformer-0.0.1-SNAPSHOT.jar';
create function order_info as 'com.wyu.transformer.hive.OrderInfoUDF' using jar 'hdfs://hh:8020/wyu/transformer/big-data-transformer-0.0.1-SNAPSHOT.jar';
create function order_total_amount as 'com.wyu.transformer.hive.OrderTotalAmountUDF' using jar 'hdfs://hh:8020/wyu/transformer/big-data-transformer-0.0.1-SNAPSHOT.jar';
